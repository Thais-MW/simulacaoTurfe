...
<body>
	...
	<div class="container mt-5">
		<div class="row">
			<div class="col-sm-8 mb-3 mb-sm-0">
				<div class="card">
					<div class="card-body">
						<h5 class="card-title">Altere o proprietário</h5>
						<form action="/simulacaoTurfe/ProprietarioUpdate" method="get">
							<div class="row">
	...
	<div class="toast-container position-fixed bottom-0 end-0 p-3">
		<div id="liveToast"
			class="toast ${proprietarioAlterado ? 'show' : 'hide'}"
			role="alert" aria-live="assertive" aria-atomic="true">
			<div class="toast-header">
				<strong class="me-auto">Proprietário
					${proprietario.getNome()} alterado com sucesso!</strong>
