						...
						<form>
							...
							<div class="row">
								<div class="col-md-3 mb-3">
									...
									<input type="number" class="form-control" id="inputVelocidade"
										name="velocidade" disabled />
								</div>
								<div class="col-md-3 mb-3">
									<label for="inputResistencia" class="form-label">Resistência:</label>
									<input type="number" class="form-control" id="inputResistencia"
										name="resistencia" disabled />
								</div>
								<div class="col-md-6 mb-3">
									<label for="inputPreco" class="form-label">Preço:</label>
									<div class="input-group">
										<span class="input-group-text">R$</span> <input type="number"
											class="form-control" id="inputPreco" name="preco"
											aria-label="Amount (to the nearest dollar)" disabled /> <span
				...
				<div class="card">
					<div class="card-body">
						...
						<p class="card-text">Caso não tenha ficado satisfeito com o
							...
							aleatoriedade permanece e no preço será acrescido R$1000,00.</p>
					</div>
				</div>
			</div>
		</div>
